...
flying_dir = diretories.flying_dir
mesh_dir = diretories.mesh_dir
...
class GenerateInitialMeshStructured3D:
    ...
    def __init__(self):
        ...
        ext_msh = mesh_dir + '/' +  input_name + diretories.ext_msh
        self.ext_out = diretories.flying_dir + '/' + input_name + diretories.ext_out_initial_mesh
        self.ext_out_h5m = self.ext_out + diretories.ext_h5m
    ...
    def save_initial_mesh(self):
        ...
        file_name_h5m_out = self.ext_out_h5m
